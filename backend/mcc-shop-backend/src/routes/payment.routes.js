...
router.post("/initiate", authenticate, async (req, res, next) => {
  try {
    ...
    if (method === "MOMO") {
      ...
      // Paystack supports MTN MoMo, Vodafone Cash, AirtelTigo Money
      ...
      paymentData = {
        ...
        checkoutUrl: null, // MoMo prompts on phone
        provider: "paystack",
        raw: paystackData,
      };
    } else if (method === "CARD") {
...
// POST /api/payments/webhook  – Paystack or Stripe webhook
